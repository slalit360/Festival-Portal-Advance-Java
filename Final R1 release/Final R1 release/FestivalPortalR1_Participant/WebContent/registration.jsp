			...
			<table>
				...
				<tr>
					...
					<table align="center" border="0">
					   ...
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Password:</td><td><input type="password" id="myPassword" name="PASSWORD" size="25" required="required"/>&nbsp; <img src="http://www.pvhc.net/img65/vrfvqdosmwzrxtstyrdb.png" width="20" height="17" onmouseover="mouseoverPass();" onmouseout="mouseoutPass();" /></td>
						   
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Confirm Password:</td><td><input type="password" id="cmyPassword" name="CPASSWORD" size="25"/>&nbsp; <img src="http://www.pvhc.net/img65/vrfvqdosmwzrxtstyrdb.png" width="20" height="17" onmouseover="cmouseoverPass();" onmouseout="cmouseoutPass();" /></td>
